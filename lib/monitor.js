 ...
 */
 Monitor.prototype._toTags = function (json) {
  var booleans = Object.keys(json).filter(function (key) {
    return isBoolean(json[key]);
  });
  var strings = Object.keys(json).filter(function (key) {
    return isString(json[key]);
  });
  var numbers = Object.keys(json).filter(function (key) {
